...
- `PROJECT_INTRODUCTION.zh-CN.md` — 中文项目介绍与当前产品边界
- `PROJECT_INTRODUCTION.en-US.md` — English project introduction and current boundaries
...
- `REAL_TARGET_SEAL.md` — manual exact-current-main target workflow
- `SEAL_CHECKLIST.md` — target-machine final seal checklist
- `SEAL_STATUS.md` — current acceptance state and historical-evidence boundary

Canonical release rules live at repository root in `SEAL_ACCEPTANCE.md`.
